...
#### 1. N+1 Query in Orders Endpoint 🔴
...
-- Current
CREATE TABLE Users (
    Bio VARCHAR(MAX)  -- ❌ Overkill
)

-- Better
CREATE TABLE Users (
    Bio VARCHAR(500)  -- ✅ Realistic limit
)
```
