...
## ⚡ YENİ: CLI Aracı ile Tek Tuşla Başla (M4)

Eğer Python yüklüyse (önerilen), kopyala-yapıştır yapmadan sistemin projenizi otomatik algılayıp LLM'e göndermeye hazır tek bir prompt dosyası üretmesini sağlayabilirsiniz.
...
# Analizi Başlat:
python cli/analyzer.py --target /projenizin/yolu --mode 1
```
*(Araç, `package.json`, `pom.xml` gibi dosyaları tanıyarak uygun modülleri otomatik seçecektir)*

Manuel kopyala-yapıştır yöntemini tercih ediyorsanız aşağıdaki adımları izleyin.
