...
**Output Format**:
```markdown
ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â´ God Files Detected:
...
```yaml
severity:
  0_circular: "ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Excellent"
  1-2_circular: "ÃƒÂ°Ã…Â¸Ã…Â¸Ã‚Â¡ Monitor"
  3-5_circular: "ÃƒÂ°Ã…Â¸Ã…Â¸Ã‚Â  Address soon"
  6+_circular: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â´ Critical architectural issue"
...
## Overall Score: 7.5/10 ÃƒÂ°Ã…Â¸Ã…Â¸Ã‚Â¡

### Summary
- ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Good: Feature-based organization
- ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Good: Consistent naming (92%)
- ÃƒÂ°Ã…Â¸Ã…Â¸Ã‚Â¡ Attention: 3 god files detected
- ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â´ Critical: 2 circular dependencies

---

## Detailed Findings

### 1. Directory Structure: 8/10 ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦
...
src/features/
  user/
    components/     ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Clear boundaries
    hooks/          ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Co-located
    services/       ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Single responsibility
    types/          ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Type safety
    __tests__/      ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Test co-location
```

### 2. File Size Distribution: 6/10 ÃƒÂ°Ã…Â¸Ã…Â¸Ã‚Â¡

| Category | Count | Percentage | Status |
|----------|-------|------------|--------|
| Small (<200) | 142 | 68% | ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Healthy |
| Medium (200-500) | 54 | 26% | ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Good |
| Large (500-1000) | 9 | 4% | ÃƒÂ°Ã…Â¸Ã…Â¸Ã‚Â¡ Monitor |
| God Files (>1000) | 3 | 1.4% | ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â´ Fix |

**God Files Requiring Immediate Attention**:

#### 1. src/utils/helpers.ts (2,847 lines) ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â´
- **Confidence**: High (95%)
...
#### 2. src/components/UserDashboard.tsx (1,342 lines) ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â´
- **Confidence**: High (90%)
- **Impact**: Medium (complex component)
- **Recommendation**: Extract sub-components
  ```
  UserDashboard.tsx (main, 200 lines)
  ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ ProfileSection.tsx
  ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ ActivityFeed.tsx
  ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ SettingsPanel.tsx
  ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ StatsWidgets.tsx
  ```
- **Effort**: 6-8 hours
- **Benefit**: 3x easier testing, better reusability

### 3. Circular Dependencies: ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â´ Critical

**Detected**: 2 circular chains

#### Circle 1:
```
UserService.ts ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ OrderService.ts ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ UserService.ts
```
...
#### Circle 2:
```
AuthContext.tsx ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ useAuth.ts ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ AuthContext.tsx
```
...
### 4. Naming Consistency: 8/10 ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦

| Pattern | Expected | Actual | Score |
|---------|----------|--------|-------|
| Components | PascalCase | 92% | ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ |
| Files | kebab-case | 88% | ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ |
| Hooks | use* prefix | 100% | ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ |
| Constants | UPPER_SNAKE | 75% | ÃƒÂ°Ã…Â¸Ã…Â¸Ã‚Â¡ |
...
### 5. Dead Code: 5/10 ÃƒÂ°Ã…Â¸Ã…Â¸Ã‚Â¡
...
### ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â´ P0 - Critical (Do This Week)
...
2. **Break Circle 1: UserService ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬Â OrderService** (2 hours)
   - Introduce UserRepository.ts
   - Success metric: `madge --circular` returns 0

### ÃƒÂ°Ã…Â¸Ã…Â¸Ã‚Â¡ P1 - High (Do This Sprint)
...
```yaml
immediate (1 week):
  - God files: 3 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ 0
  - Circular deps: 2 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ 0
...
### ÃƒÂ¢Ã‚ÂÃ…â€™ The "utils" Graveyard
```
...
### ÃƒÂ¢Ã‚ÂÃ…â€™ Feature Coupling
```
features/user ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ features/order ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ features/user
```
- **Why Bad**: Can't extract features independently
- **Fix**: Shared domain layer or events

### ÃƒÂ¢Ã‚ÂÃ…â€™ Deep Nesting
```
